...
public class LogicalParticipantImpl extends LogicalCharacteristicImpl implements LogicalParticipant
{
   ...
   * @ordered
   */
  protected LogicalAssociation type;
   ...
   */
  @Override
  public LogicalAssociation getType()
  {
    if (type != null && type.eIsProxy())
    {
      InternalEObject oldType = (InternalEObject)type;
      type = (LogicalAssociation)eResolveProxy(oldType);
      if (type != oldType)
      {
   ...
   * @generated
   */
  public LogicalAssociation basicGetType()
  {
    return type;
  }
   ...
   */
  @Override
  public void setType(LogicalAssociation newType)
  {
    LogicalAssociation oldType = type;
    type = newType;
    if (eNotificationRequired())
  ...
  public void eSet(int featureID, Object newValue)
  {
    ...
    {
      case UddlPackage.LOGICAL_PARTICIPANT__TYPE:
        setType((LogicalAssociation)newValue);
        return;
      case UddlPackage.LOGICAL_PARTICIPANT__REALIZES:
  ...
  public void eUnset(int featureID)
  {
    ...
    {
      case UddlPackage.LOGICAL_PARTICIPANT__TYPE:
        setType((LogicalAssociation)null);
        return;
      case UddlPackage.LOGICAL_PARTICIPANT__REALIZES:
