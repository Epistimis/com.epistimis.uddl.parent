...
import com.epistimis.uddl.uddl.Import;
...
public class UddlPackageImpl extends EPackageImpl implements UddlPackage
{
   ...
   * @generated
   */
  private EClass platformCharTypeEClass = null;
   ...
   * @generated
   */
  private EClass platformWCharEClass = null;
  ...
  {
    return (EReference)logicalMeasurementSystemConversionEClass.getEStructuralFeatures().get(1);
  }
  ...
  {
    return (EAttribute)logicalMeasurementSystemConversionEClass.getEStructuralFeatures().get(2);
  }
  ...
  {
    return (EReference)logicalMeasurementConversionEClass.getEStructuralFeatures().get(1);
  }
  ...
  {
    return (EAttribute)logicalMeasurementConversionEClass.getEStructuralFeatures().get(2);
  }
   ...
   */
  @Override
  public EClass getPlatformCharType()
  {
    return platformCharTypeEClass;
  }
   ...
   */
  @Override
  public EClass getPlatformWChar()
  {
    return platformWCharEClass;
  }
   ...
   */
  @Override
  public EAttribute getPlatformArray_Name()
  {
    return (EAttribute)platformArrayEClass.getEStructuralFeatures().get(1);
  }
   ...
   */
  @Override
  public EAttribute getPlatformArray_Description()
  {
    return (EAttribute)platformArrayEClass.getEStructuralFeatures().get(2);
  }
   ...
   */
  @Override
  public EReference getPlatformArray_Realizes()
  {
    return (EReference)platformArrayEClass.getEStructuralFeatures().get(3);
  }
  ...
  public void createPackageContents()
  {
    ...
    platformCharTypeEClass = createEClass(PLATFORM_CHAR_TYPE);

    platformCharEClass = createEClass(PLATFORM_CHAR);

    platformWCharEClass = createEClass(PLATFORM_WCHAR);
    ...
    createEAttribute(platformArrayEClass, PLATFORM_ARRAY__NAME);
    createEAttribute(platformArrayEClass, PLATFORM_ARRAY__DESCRIPTION);
    createEReference(platformArrayEClass, PLATFORM_ARRAY__REALIZES);
  ...
  public void initializePackageContents()
  {
    ...
    platformCharTypeEClass.getESuperTypes().add(this.getPlatformPrimitive());
    platformCharEClass.getESuperTypes().add(this.getPlatformCharType());
    platformWCharEClass.getESuperTypes().add(this.getPlatformCharType());
    ...
    initEReference(getLogicalParticipant_Type(), this.getLogicalAssociation(), null, "type", null, 0, 1, LogicalParticipant.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEClass(platformCharTypeEClass, PlatformCharType.class, "PlatformCharType", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

    initEClass(platformCharEClass, PlatformChar.class, "PlatformChar", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

    initEClass(platformWCharEClass, PlatformWChar.class, "PlatformWChar", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    ...
    initEAttribute(getPlatformArray_Name(), ecorePackage.getEString(), "name", null, 0, 1, PlatformArray.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPlatformArray_Description(), ecorePackage.getEString(), "description", null, 0, 1, PlatformArray.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getPlatformArray_Realizes(), this.getLogicalElement(), null, "realizes", null, 0, 1, PlatformArray.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getPlatformParticipant_Type(), this.getPlatformAssociation(), null, "type", null, 0, 1, PlatformParticipant.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
