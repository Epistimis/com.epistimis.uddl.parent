...
public class UddlSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == UddlPackage.eINSTANCE)
			...
			case UddlPackage.PLATFORM_WCHAR:
				sequence_PlatformWChar(context, (PlatformWChar) semanticObject); 
				return; 
			}
	...
	protected void sequence_Import(ISerializationContext context, Import semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, UddlPackage.Literals.IMPORT__IMPORTED_NAMESPACE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, UddlPackage.Literals.IMPORT__IMPORTED_NAMESPACE));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	 ...
	 *     PlatformCharType returns PlatformChar
	 ...
	 * <pre>
	 * Contexts:
	 *     UddlElement returns PlatformWChar
	 *     PlatformElement returns PlatformWChar
	 *     PlatformComposableElement returns PlatformWChar
	 *     PlatformDataType returns PlatformWChar
	 *     PlatformPrimitive returns PlatformWChar
	 *     PlatformCharType returns PlatformWChar
	 *     PlatformWChar returns PlatformWChar
	 *
	 * Constraint:
	 *     (name=ID description=STRING? realizes=[LogicalElement|QN])
	 * </pre>
	 */
	protected void sequence_PlatformWChar(ISerializationContext context, PlatformWChar semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
